...
import 'package:univercity/Helper/token-methods.dart';
...
class RestApi {
  ...
  static responseHandler({Response? response,Function? successCallback,printResponse=false,popupMessage=true})async{
    if(response==null){
      if(isConnected)
